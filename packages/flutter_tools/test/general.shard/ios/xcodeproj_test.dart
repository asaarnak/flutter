...
void main() {
  ...
  const kFindProcessResolvePackagesCommand = FakeCommand(
    command: <String>[
      ...
      '-n',
      '-f',
      'xcrun xcodebuild -clonedSourcePackagesDirPath /build/ios/SourcePackages -resolvePackageDependencies',
    ],
  );
      ...
      fakeProcessManager.addCommands(<FakeCommand>[
        ...
        const FakeCommand(
          command: <String>[
            ...
            '-n',
            '-f',
            'xcrun xcodebuild -clonedSourcePackagesDirPath /build/macos/SourcePackages -resolvePackageDependencies',
          ],
        ),
        const FakeCommand(
          command: <String>[
      ...
      fakeProcessManager.addCommands(<FakeCommand>[
        ...
        FakeCommand(
          command: <String>[
            ...
            '-n',
            '-f',
            'xcrun xcodebuild -clonedSourcePackagesDirPath /${buildDirectory.path}/SourcePackages -resolvePackageDependencies',
          ],
          stdout: '12345',
        ),
